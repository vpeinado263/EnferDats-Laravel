...
@push('styles')
<style>
    /* Copia aquí los estilos que estaban en el <style> del dashboard,
       pero puedes dejarlos en un archivo CSS separado si prefieres.
       Yo los mantengo aquí para simplificar. */
    body {
        background: #f8f9fa;
